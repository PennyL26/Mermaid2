...
export const RESULT_MESSAGE_BANDS = [
  { min: 100, max: 100, color: "blue", text: "ΑΓΑΠΗ ΜΟΥ ΓΛΥΚΙΑ!!! ΕΙΣΑΙ ΑΨΟΓΗ!!! ΕΞΑΙΡΕΤΙΚΗ!!!" },
  { min: 90, max: 99.999, color: "green", text: "Μπράβο ομορφιά μου. Όχι όμως τέλεια." },
  { min: 80, max: 89.999, color: "green", text: "Μωρό μου!. Μπορείς και καλύτερα..." },
  { min: 75, max: 79.999, color: "red", text: "Ποια είσαι εσύ; Σίγουρα όχι η Penny!!!" },
  { min: 70, max: 74.999, color: "orange", text: "Τεμπελιάζουμε Penny!!!" },
  { min: 60, max: 69.999, color: "red", text: "Τώρα έπεσες στο επίπεδο αρνάρη…" },
  { min: 55, max: 59.999, color: "red", text: "Τώρα προσπαθείς να δώσεις στο επίπεδο αρνάρη ελπίδες..." },
  { min: 0, max: 54.999, color: "red", text: "Μήπως να βρεις να κάνεις κάτι άλλο πιο εποικοδομητικό;;;" },
];
